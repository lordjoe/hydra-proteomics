/*
 $Id: ExtensionDisableInterface.java 4174 2011-03-22 08:42:35Z olle $

 Copyright (C) 2011 Fredrik Levander, Olle Mansson
 ...
 *
 */
public interface ExtensionDisableInterface
{
	/* returns the disabled flag */
	public boolean fetchExtensionDisabledFlag();
