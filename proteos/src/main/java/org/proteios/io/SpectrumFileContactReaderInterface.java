/*
 $Id: SpectrumFileContactReaderInterface.java 3207 2009-04-09 06:48:11Z gregory $
...
/**
 * This interface defines methods to access contact information
...
public interface SpectrumFileContactReaderInterface
{
	 ...
	 * 
	 * @return SpectrumFileContactInterface The spectrum file contact data.
	 */
	public SpectrumFileContactInterface getSpectrumContact();
}
