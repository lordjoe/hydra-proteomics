/*
	$Id: DoubleParameterValueData.java 3207 2009-04-09 06:48:11Z gregory $
	...
	extends ParameterValueData<Double>
{
	...
	/**
		@hibernate.bag table="`DoubleValues`" lazy="true" cascade="all"
		@hibernate.collection-key column="`id`"
		@hibernate.collection-element column="`value`" type="double" not-null="true"
	*/
	@Override
