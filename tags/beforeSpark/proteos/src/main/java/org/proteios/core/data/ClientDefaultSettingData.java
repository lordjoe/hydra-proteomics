/*
 $Id: ClientDefaultSettingData.java 3207 2009-04-09 06:48:11Z gregory $
 ...
 * @hibernate.class table="`ClienDefaultSettings`" lazy="false"
 */
		...
		extends SettingData
{
	 ...
	 * @hibernate.column name="`client_id`" not-null="true"
