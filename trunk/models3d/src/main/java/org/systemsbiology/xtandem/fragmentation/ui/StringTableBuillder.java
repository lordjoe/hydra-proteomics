 ...
 * Date: 6/25/12
 */
public class StringTableBuillder extends AbstractHtmlFragmentHolder {
    public static final StringTableBuillder[] EMPTY_ARRAY = {};

    private final String[] m_Texts;
    private final String[] m_References;
    private final int m_RowLength;
    public StringTableBuillder(final IHtmlFragmentHolder page, String[] text, String[] refs, int rowLength) {
        super(page);
        m_References = refs;
        m_Texts = text;
