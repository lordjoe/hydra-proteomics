...
public class SegwayCRC
{
    ...
    public static final short[] STEVE_SLOW_KEY_VALUES = {
            0x51, 0x14, 0x10, 0x0C, 0xb7, 0x19, 0x84, 0x2e, 0x83, 0xfd, 0x76,
            0xAA, 0xa3, 0x06, 0x00, 0x48
    };
    // b0 red key
    public static final short[] STEVE_SLOWEST_KEY_VALUES = {
            0x90, 0x55, 0x10, 0x0C, 0xb7, 0x19, 0x84, 0x2e, 0x83, 0xfd, 0x76,
            0xAA, 0xa3, 0x02, 0x00, 0x48
    };
    // b0 red key
    public static final short[] STEVE_IMTERMEDIATE_VALUES = {
            0x92, 0x75, 0x10, 0x0C, 0xb7, 0x19, 0x84, 0x2e, 0x83, 0xfd, 0x76,
            0xAA, 0xa3, 0x08, 0x00, 0x48
    };
    // b0 red key
    public static final short[] STEVE_SLOWER_KEY_VALUES = {
            0x91, 0xB5, 0x10, 0x0C, 0xb7, 0x19, 0x84, 0x2e, 0x83, 0xfd, 0x76,
            0xAA, 0xa3, 0x04, 0x00, 0x48
    };
    ...
    {
        short buf[] = STEVE_SLOWER_KEY_VALUES; //ORIGINAL_KEY_VALUES;
        int i, crc;
        short p1, p2, p3;
