...
/**
 * org.systemsbiology.hadoop.RunExecutableTest
 */
public class RunExecutableTest {


    public static enum NumberFilesSeen {
        AtMapper, AtReducer, AtSource
    }
...
//
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(RunExecutableTest.class);
        job.setMapperClass(FileMapper.class);
        //    job.setCombinerClass(IntSumReducer.class);
        job.setReducerClass(HelloWorldExecutableReducer.class);
        ...
        String s = "s3n://lordjoe/Hello";
         DistributedCache.addCacheFile(new Path(s + "#Hello.x").toUri(), conf);
           // System.err.println("Cannot find " + "s3n://lordjoe/Hello");
         DistributedCache.addCacheFile(new Path("s3n://lordjoe/FeeFie.txt#FeeFie.txt").toUri(), conf);
