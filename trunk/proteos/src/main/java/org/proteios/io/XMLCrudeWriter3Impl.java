/*
 $Id: XMLCrudeWriter3Impl.java 3204 2009-04-07 09:17:04Z olle $
 ...
 */
public class XMLCrudeWriter3Impl implements XMLCrudeWriter, XMLCrudeWriter3
{
	/*
		...
		throws IOException
	{
		...
		try {
			...
			throw new IOException("Error writing string \"" + string + "\": " + e);
		}
	}
	...
	// -------------------------------------------
	/*
	 * From the XMLCrudeWriter2 interface
	 * -------------------------------------------
	 */
	/**
	...
	// -------------------------------------------
	/*
	 * From the XMLCrudeWriter3 interface
	 * -------------------------------------------
	 */
	/**
