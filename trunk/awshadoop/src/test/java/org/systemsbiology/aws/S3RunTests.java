...
public class S3RunTests {
    ...
    public void testLoad()
    {
        ...
        AWSUtilities.AWS_CONFIGURE_FILE_SYSTEM.configureFileSystem(cfg,"s3n://lordjoe/");
        cfg.set(XTandemHadoopUtilities.PATH_KEY, "s3n://lordjoe/Sample2/");
        cfg.set(XTandemHadoopUtilities.PARAMS_KEY, "s3n://lordjoe/Sample2/tandem.xml");
        XTandemMain.setRequiredPathPrefix("s3n://lordjoe/Sample2/");
...
//        Assert.assertEquals( XTandemMain.getRequiredPathPrefix() + "tandem.xml",main.getTaskFile());
        Assert.assertEquals( XTandemMain.getRequiredPathPrefix() + "taxonomy.xml",main.getTaxonomyName());
    ...
    {
        String defaultDirectory = "lordjoe" ;
