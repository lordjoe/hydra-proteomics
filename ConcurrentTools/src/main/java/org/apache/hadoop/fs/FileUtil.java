 /* =================================================
 // NOTE I had to copy the hadoop code to patch it to work with
 // windows
   the issue is that checkPermission will not work in windows but can be ignored

Critical changes look like
 ...
 //http://stackoverflow.com/questions/15321908/wordcount-example-error
 // ===============================================
*/
/**
...
//
//    // |Added Slewis
//    public static final boolean RUNNING_ON_WINDOWS = System.getProperty("os.name").toLowerCase().contains("windows");
//
//    /**
